  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">@lang('movie.movie')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class='row'>
            ...
            <div class="modal fade" id="exampleModalBDelete" tabindex="-1" movie="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" movie="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ route('admin.movie.bulckDelete') }}" method="POST">
                        @csrf
                        @method('delete')
...
@push('scripts')
    ...
    <script>
         ...
         $(document).on('change','.movie',function(){
            var allChecked = $('.movie:checked').length === $('.movie').length;
